...
<body id="sample">
  <div class="textColumn">
    <h1>Congratulations This is 4th change</h1>
    <p>Your first AWS Elastic Beanstalk Python Application is now running on your own dedicated environment in the AWS Cloud. My second change!</p>
  </div>
